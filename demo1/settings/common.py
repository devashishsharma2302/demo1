...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '#b7y%-osq(yx669zenj1)z96ku%*9v-gq@m*v2kl*)8g3gwol(')
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'when': 'midnight',
            'backupCount': 10,
            'filename': os.path.join(LOG_DIR, 'demo1.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
